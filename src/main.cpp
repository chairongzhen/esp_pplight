...
EasyButton resetButton(RESET_BUTTON);
...
LED_ESP32 led1(12, 0, 100);
LED_ESP32 led2(13, 1, 100);
LED_ESP32 led3(17, 2, 100);
LED_ESP32 led4(22, 3, 100); // the led15 has trouble when rest the light will lighting a sceond
LED_ESP32 led5(23, 10, 100);
LED_ESP32 led6(27, 5, 100);
LED_ESP32 led7(4, 6, 100);
LED_ESP32 led8(21, 7, 100); // the channel 8 has some trouble for switch the lgiht to 0 , is disable

// 信号灯
LED_ESP32 led0(26,8,100);
...
NTPClient timeClient(ntpUDP, "ntp2.aliyun.com", 28800, 60000);
...
void setup()
{
  ...
  resetButton.begin();
  resetButton.onPressedFor(5000, handleRestButtonChanged);
  ...
  if(false){
    ...
    else
    {
      ...
      signalticker.attach(0.5,onBlink);
